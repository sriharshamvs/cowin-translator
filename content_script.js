...
const translations = [
  ...
  {
    word: "You can log into the Co-WIN portal using the link www.cowin.gov.in and click on the â€œRegister/Sign In yourself tab to register for COVID-19 vaccination.",
    replacedWord:
  ...
  {
    word: "All citizens aged 18 years and above can register for vaccination.  Is online registration mandatory for Covid 19 vaccination?  Vaccination Centres provide for a limited number of on-spot registration slots every day. Citizens aged 45 years and above can schedule appointments online or walk-in to vaccination centres. However, Citizens aged 18-44 years should mandatorily register themselves and schedule appointment online before going to vaccination centre. In general, all citizens are recommended to register online and schedule vaccination in advance for a hassle-free vaccination experience.",
    replacedWord:
      "18 సంవత్సరాల మరియు అంతకంటే ఎక్కువ వయస్సు ఉన్న పౌరులందరూ టీకా కోసం నమోదు చేసుకోవచ్చు. కోవిడ్ 19 టీకా కోసం ఆన్‌లైన్ నమోదు తప్పనిసరినా? టీకా కేంద్రాలు ప్రతిరోజూ పరిమిత సంఖ్యలో ఆన్-స్పాట్ రిజిస్ట్రేషన్ స్లాట్‌లను అందిస్తాయి. 45 సంవత్సరాల మరియు అంతకంటే ఎక్కువ వయస్సు ఉన్న పౌరులు ఆన్‌లైన్‌లో appointment షెడ్యూల్ చేయవచ్చు లేదా టీకా కేంద్రాలకు వారె వెల్లవచును. ఏదేమైనా, 18-44 సంవత్సరాల వయస్సు గల పౌరులు టీకా కేంద్రానికి వెళ్లేముందు తమను తాము తప్పనిసరిగా నమోదు చేసుకోవాలి మరియు ఆన్‌లైన్‌లో నియామకాన్ని షెడ్యూల్ చేయాలి. సాధారణంగా, పౌరులందరూ ఆన్‌లైన్‌లో నమోదు చేసుకోవాలని మరియు ఇబ్బంది లేని టీకా అనుభవం కోసం టీకా ముందుగానే షెడ్యూల్ చేయాలని సిఫార్సు చేస్తారు."
  },
  {
  ...
  },
  {
    ...
    replacedWord:
      "ఒకే మొబైల్ నంబర్ ఉపయోగించి టీకా కోసం 4 మంది వరకు నమోదు చేసుకోవచ్చు. పౌరులు ఆన్‌లైన్ నమోదు కోసం స్నేహితులు లేదా కుటుంబ సభ్యుల సహాయం తీసుకోవచ్చు."
  },
  {
  ...
  {
    word: "Yes, you can register on Co-WIN portal using any of the following ID proofs:a.\tAadhaar card  b.\tDriving License  c.\tPAN card  d.\tPassport  e.\tPension Passbook  f.\tNPR Smart Card  g.\tVoter ID (EPIC)",
    replacedWord:
      "అవును, మీరు కింది ఐడి ప్రూఫ్‌లను ఉపయోగించి కో-విన్ పోర్టల్‌లో నమోదు చేసుకోవచ్చు: a. ఆధార్ కార్డు b. డ్రైవింగ్ లైసెన్స్ సి. పాన్ కార్డు డి. పాస్పోర్ట్ ఇ. పెన్షన్ పాస్బుక్ f. ఎన్‌పిఆర్ స్మార్ట్ కార్డ్ గ్రా. ఓటరు ID (EPIC)"
  },
  {
  ...
  {
    word: "F. Reporting Side effects  Whom do I contact in case of side effects from vaccination?",
    replacedWord:
      "ఎఫ్. రిపోర్టింగ్ దుష్ప్రభావాలు టీకా నుండి దుష్ప్రభావాల విషయంలో నేను ఎవరిని సంప్రదించాలి?"
  },
  {
    word: "E. Vaccine Certificate  Why do I need a vaccination certificate?",
    replacedWord:
      "E. వ్యాక్సిన్ సర్టిఫికేట్ నాకు టీకా సర్టిఫికేట్ ఎందుకు అవసరం?"
  },
  {
  ...
  {
    word: "D. Vaccination  Is vaccination free at all vaccination centres?",
    replacedWord: "D. టీకా అన్ని టీకా కేంద్రాలలో టీకా ఉచితం?"
  },
  {
    word: "No. Currently, vaccination is free at Government hospitals and charged at INR 250 in Private hospitals for citizens aged 45 years and above.  From 1st May onwards, the Vaccination for people of 45 years or more will continue to be free at the Government facilities. For people between 18 to 44 years the States will announce the policy relating to payment. Vaccination will be priced by private facilities and you can see the price of each vaccine at the time of booking.",
    replacedWord:
      "ప్రస్తుతం, ప్రభుత్వ ఆసుపత్రులలో టీకా ఉచితం మరియు 45 సంవత్సరాల మరియు అంతకంటే ఎక్కువ వయస్సు ఉన్న పౌరులకు ప్రైవేట్ ఆసుపత్రులలో 250 రూపాయలు వసూలు చేస్తారు.  మే 1 వ తేదీ నుండి, 45 సంవత్సరాలు లేదా అంతకంటే ఎక్కువ వయస్సు ఉన్నవారికి టీకాలు వేయడం ప్రభుత్వ సౌకర్యాల వద్ద ఉచితంగా కొనసాగుతుంది.  18 నుండి 44 సంవత్సరాల మధ్య ఉన్నవారికి, చెల్లింపులకు సంబంధించిన విధానాన్ని రాష్ట్రాలు ప్రకటిస్తాయి.  టీకాకు ప్రైవేట్ సదుపాయాల ద్వారా ధర నిర్ణయించబడుతుంది మరియు బుకింగ్ సమయంలో ప్రతి టీకా ధరను మీరు చూడవచ్చు."
  },
  {
  ...
  {
    word: "You can search in Co-WIN portal (or Aarogya Setu) for the vaccination centre nearest to your location by either searching through PIN code or by choosing the State and the District.  What if I cannot go for vaccination on the date of appointment?",
    replacedWord:
  ...
  },
  {
    word: "When should I take the 2nd dose of vaccination?  It is recommended that the 2nd dose of COVAXIN should be administered in the interval of 4 to 6 weeks from the date of 1st dose administration. For COVISHIELD the recommended interval is 4 to 8 weeks while an interval of 6 to 8 weeks gives an enhanced protection. You may choose the date of 2nd dose vaccination as per your convenience.",
    replacedWord:
      "టీకా యొక్క 2 వ మోతాదును నేను ఎప్పుడు తీసుకోవాలి?  1 వ మోతాదు పరిపాలన తేదీ నుండి 4 నుండి 6 వారాల వ్యవధిలో COVAXIN యొక్క 2 వ మోతాదును అందించాలని సిఫార్సు చేయబడింది.  COVISHIELD కొరకు సిఫార్సు చేయబడిన విరామం 4 నుండి 8 వారాలు కాగా, 6 నుండి 8 వారాల విరామం మెరుగైన రక్షణను ఇస్తుంది.  మీ సౌలభ్యం ప్రకారం మీరు 2 వ మోతాదు టీకా తేదీని ఎంచుకోవచ్చు."
  },
  {
    word: "Will my 2nd dose appointment be automatically scheduled by Co-WIN system?",
    replacedWord:
  ...
  {
    word: "How it Works Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.Choose Vaccine LocationSelect your nearby Vaccine Center for vaccinationConfirm your SlotBook your slot to Get VaccineAny Question? Please follow our Frequently asked questions (FAQ)Know how to book your appointment Dos and Don'ts",
    replacedWord: ""
  },
  {
    word: "How it Works Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.Choose Vaccine LocationSelect your nearby Vaccine Center for vaccinationConfirm your SlotBook your slot to Get VaccineAny Question? Please follow our Frequently asked questions (FAQ)Know how to book your appointment Dos and Don'ts",
  ...
  {
    word: "Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.Choose Vaccine LocationSelect your nearby Vaccine Center for vaccinationConfirm your SlotBook your slot to Get VaccineAny Question? Please follow our Frequently asked questions (FAQ)Know how to book your appointment Dos and Don'ts",
    replacedWord:
      "అది ఎలా పని చేస్తుంది.మీరే నమోదు చేసుకోండి,మీ ఫోన్ నంబర్. / ఆధార్ నంబర్/మీ గుర్తింపు కార్డు. మీ సమీపంలో ఉన్న టీకా కేంద్రంని ఎంచుకోండి. మీ టీకా స్లాట్ ని నిర్ధారించండి.ఏవైనా ప్రశ్నలు కొరకు లేదా సమస్యల పరిష్కారం కోసం మా ఎఫ్ ఎ క్యూ లను అనుసరించించండి"
  },
  {
    word: "Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.Choose Vaccine LocationSelect your nearby Vaccine Center for vaccinationConfirm your SlotBook your slot to Get VaccineAny Question? Please follow our Frequently asked questions (FAQ)",
    replacedWord:
      "మీరే నమోదు చేసుకోండి మీ మొబైల్ నంబర్ ఉపయోగించి నమోదు చేసుకోండి. లేదా ఆధార్ నం. లేదా మరేదైనా ఐడెంటిటీ డాక్స్. టీకా స్థానాన్ని ఎంచుకోండి టీకా కోసం మీ సమీప వ్యాక్సిన్ కేంద్రాన్ని ఎంచుకోండి టీకా ఏదైనా ప్రశ్న పొందడానికి మీ స్లాట్‌బుక్‌ను మీ స్లాట్‌గా నిర్ధారించండి? దయచేసి మా తరచుగా అడిగే ప్రశ్నలను (తరచుగా అడిగే ప్రశ్నలు) అనుసరించండి"
  },
  {
    word: "Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.Choose Vaccine LocationSelect your nearby Vaccine Center for vaccinationConfirm your SlotBook your slot to Get VaccineAny Question? Please follow our Frequently asked questions (FAQ)",
    replacedWord:
  ...
  {
    word: "Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.",
    replacedWord:
      "మీరే నమోదు చేసుకోండి మీ మొబైల్ నంబర్ ఉపయోగించి నమోదు చేసుకోండి. లేదా ఆధార్ నం. లేదా ఏదైనా ఇతర గుర్తింపు డాక్స్."
  },
  {
    word: "Register Yourself Register using your Mobile no. or Aadhaar no. or any other Identity docs.",
    replacedWord:
  ...
  },
  {
    ...
    replacedWord: "మీకు మీరుగా నమోదు చేసుకోండి"
  },
  {
